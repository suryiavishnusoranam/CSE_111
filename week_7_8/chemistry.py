...
def main():
    chemical_formula = input("Enter chemical formula for a molecule: ") # Get a chemical formula for a molecule from the user.

    mass = float(input("Enter mass of a chemical sample in grams: ")) # Get the mass of a chemical sample in grams from the user.

    table = make_periodic_table()

    convert = parse_formula(chemical_formula, table)

    molar_mass = compute_molar_mass(convert, table)
